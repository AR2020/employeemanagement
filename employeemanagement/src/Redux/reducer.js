const initialstate = {    
    ...
                        (content, i) => content.id === action.payload.id ? {...content, employee_name : action.payload.employee_name ,  employee_salary : action.payload.employee_salary,employee_age:action.payload.employee_age }    
                                                : content)    
                };    
